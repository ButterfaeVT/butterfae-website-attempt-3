...
I was lucky enough to speak to [Puppers19(AKA: SGTBLANK),](https://www.twitch.tv/puppers19) a previous client of Bliss_Bella who is the artist who started this whole investigation into the company on my part to begin with.  In talking to Puppers, he told me that the [Trustpilot review](bellaa-rowan-sgt-blank.jpg) of his commission which included a shoutout for her Vtuber models is fake as he never gave her a shoutout of any kind and his [model](https://booth.pm/en/items/4760563) was from TsukinoHana as stated in the [panels](Puppers%20Panels.png) of his about section on twitch.
...
When being paid for a commission, I believe that there is usually a standard method of payment, especially if its a company running the operation.  these artists often ask for Paypal as in the case of [StillChris,](Chris%20Invoice) [HimmyVT,](Himmy%20Invoice) and [Spaceman,](Spaceman%20Invoice) but when talking to my friend Nix, the same person who did HimmyVT's commission asked for [Zelle](Have%20you%20got%20a%20Zelle.png) before any other form of payment.  This struck me a bit weird as normally I see artists go through paypal and then maybe another method if that doesn't work out for some reason.
...
The [testimonials on their website](https://humantekart.com/testimonials/) showcase tweets from clients shouting out their artists, but they never show the same artist more than once with one exception.  This may be because they want to show multiple reviews of different artists, but if an artist was doing really good, I would imagine that they would want them to be front and center so that they could get more commissions and they already have one artist with more than one review.  Screenshots of the testimonials page included [here.](Humantek%20Testimonials)

## They Often Ask for a Shoutout Post and/or Other Forms of Recommendation
After the work is done, or even before in some cases, they will ask for shoutouts on [twitter, instagram](Still%20Chris%20Shaniqua%20Shoutout.png), [discord](Bella%20Shoutout.png), and/or [Trustpilot](Leading%20Art%20Companies.png).  Sometimes they even make panels for the client to put under their stream.  I understand asking for referrals when the work is finished, and its a definitely common courtesy to give your artist a shoutout after they do work for you, especially if you like it, but asking almost a week in advance like in the case for [HimmyVT](Bella%20reference%20request%20himmy.png) just feels weird.  
